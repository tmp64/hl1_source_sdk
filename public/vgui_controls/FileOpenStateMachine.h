...
public:
	...
	virtual void SetupFileOpenDialog( vgui2::FileOpenDialog *pDialog, bool bOpenFile, const char *pFileFormat, KeyValues *pContextKeyValues ) = 0;
...
public:
	...
	FileOpenStateMachine( vgui2::Panel *pParent, IFileOpenStateMachineClient *pClient );
