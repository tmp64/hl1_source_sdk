...
//-----------------------------------------------------------------------------
class COperationFileListFrame : public vgui2::Frame
{
	DECLARE_CLASS_SIMPLE( COperationFileListFrame, vgui2::Frame );

public:
	// NOTE: The dialog ID is used to allow dialogs to have different configurations saved 
	COperationFileListFrame( vgui2::Panel *pParent, const char *pTitle, const char *pColumnHeader, bool bShowDescription, bool bShowOkOnly = false, int nDialogID = 1 );
...
private:
	...
	vgui2::ListPanel *m_pFileBrowser;
	vgui2::Splitter *m_pSplitter;
	vgui2::TextEntry *m_pDescription;
...
public:
	CPerforceFileListFrame( vgui2::Panel *pParent, const char *pTitle, const char *pColumnHeader, PerforceAction_t action );
...
//-----------------------------------------------------------------------------
void ShowPerforceQuery( vgui2::Panel *pParent, const char *pFileName, vgui2::Panel *pActionSignalTarget, KeyValues *pKeyValues, PerforceAction_t actionFilter = PERFORCE_ACTION_NONE );
