...
//-----------------------------------------------------------------------------
class CConsolePanel : public vgui2::EditablePanel, public IConsoleDisplayFunc
{
	DECLARE_CLASS_SIMPLE( CConsolePanel, vgui2::EditablePanel );
...
{
	DECLARE_CLASS_SIMPLE( CConsoleDialog, vgui2::Frame );
