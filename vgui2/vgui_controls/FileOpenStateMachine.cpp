...
// Constructor
//-----------------------------------------------------------------------------
FileOpenStateMachine::FileOpenStateMachine( vgui2::Panel *pParent, IFileOpenStateMachineClient *pClient ) : BaseClass( pParent, "FileOpenStateMachine" )
{
	m_pClient = pClient;
...
void FileOpenStateMachine::OverwriteFileDialog( )
{
	...
	vgui2::MessageBox *pMessageBox = new vgui2::MessageBox( "Overwrite Existing File?", pBuf, GetParent() );
...
void FileOpenStateMachine::MakeFileWriteableDialog( )
{
	...
	vgui2::MessageBox *pMessageBox = new vgui2::MessageBox( "Make File Writeable?", pBuf, GetParent() );
	pMessageBox->AddActionSignalTarget( this );
	pMessageBox->SetOKButtonVisible( true );
	pMessageBox->SetOKButtonText( "Yes" );
	pMessageBox->SetCancelButtonVisible( true );
